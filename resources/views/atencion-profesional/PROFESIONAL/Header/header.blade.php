...
<body>
    <header>
        <div class="logo-container">
            <a href="#"><img href="/inicio-de-sesion/Modulo-iniciar-sesion/home/home.html" src="{{ asset('img/atencion-profesional/PROFESIONAL/Header/Logo.jpeg') }}" alt="Logo" class="logo"></a>
        ...
        <nav class="nav-links">
            ...
            <a href="/atencion-profesional/PROFESIONAL/Footer/inicio/link/quienessomos.blade" class="nav-item  ">Acerca de </a>
