...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/atencion-profesional/PROFESIONAL/ProgramarCita_Profesional/ProgramarCita.css') }}">
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="buzon-container" id="buzonContainer">
                <!-- Las tarjetas de citas se generarán dinámicamente aquí -->
            </div>
        </div>
...
<script src="{{ asset('js/atencion-profesional/PROFESIONAL/ProgramarCita_Profesional/script.js') }}"></script>
