...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <link rel="stylesheet" href="{{ asset('css/atencion-profesional/USUARIO/Reseñas_Usuario/ReseñaUsuario.css') }}">
...
<body>
  ...
  <script src="{{ asset('js/atencion-profesional/USUARIO/Reseñas_Usuario/script.js') }}"></script>
</body>
</html>
