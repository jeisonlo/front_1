...
<body>
  ...
  <div class="stories-wrapper">
    ...
    <div class="cards">
      ...
      <a href="{{ route('citas.usuario') }}"><div class="cuadro"><img src="https://res.cloudinary.com/dmisxvtp9/image/upload/v1745353904/Profesionales_ghqweq.jpg" alt="Profesionales"><h3>Profesionales</h3></div></a>
