document.addEventListener('DOMContentLoaded', function () {
    ...
    // Cargar y mostrar los podcasts de "Motivación"
    fetchPodcastsByCategory('Motivación').then(podcasts => {
        ...
        // Filtrar explícitamente solo los podcasts de "Motivación"
        const motivacionPodcasts = podcasts.filter(podcast => podcast.category === 'Motivación');
        console.log('Podcasts filtrados (solo Motivación):', motivacionPodcasts);

        if (motivacionPodcasts.length > 0) {
            motivacionPodcasts.forEach(podcast => {
            ...
            console.log('No se encontraron podcasts en la categoría "Motivación".');
