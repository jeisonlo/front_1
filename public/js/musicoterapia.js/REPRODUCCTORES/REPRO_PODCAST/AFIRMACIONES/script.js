document.addEventListener('DOMContentLoaded', function () {
    ...
    // Cargar y mostrar los podcasts de "Afirmaciones"
    fetchPodcastsByCategory('Afirmaciones').then(podcasts => {
        ...
        // Filtrar explícitamente solo los podcasts de "Afirmaciones"
        const afirmacionesPodcasts = podcasts.filter(podcast => podcast.category === 'Afirmaciones');
        console.log('Podcasts filtrados (solo Afirmaciones):', afirmacionesPodcasts);

        if (afirmacionesPodcasts.length > 0) {
            afirmacionesPodcasts.forEach(podcast => {
            ...
            console.log('No se encontraron podcasts en la categoría "Afirmaciones".');
